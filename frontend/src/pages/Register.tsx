    ...
    <div className="min-h-screen bg-[#0A0F1E] flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[44%] bg-gradient-to-br from-[#0F172A] to-[#0A0F1E] border-r border-white/5 px-14 py-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          {/* KYC steps */}
          <h3 className="text-white font-semibold text-base mb-5">How KYC works</h3>
          <div className="space-y-4">
            {[
              { step: '01', title: 'Submit your info', desc: 'Fill in your personal and business details.' },
              { step: '02', title: 'Xendit verification', desc: 'Your identity is verified via the Xendit platform.' },
              { step: '03', title: 'Admin approval', desc: 'A super admin reviews and approves your application.' },
              { step: '04', title: 'Dashboard access', desc: 'Sign in with your Telegram account to manage payments.' },
            ].map(({ step, title, desc }) => (
              <div key={step} className="flex items-start gap-4">
                <div className="h-8 w-8 shrink-0 bg-blue-500/15 border border-blue-500/25 rounded-lg flex items-center justify-center">
          ...
          <div className="mt-8 bg-emerald-500/8 border border-emerald-500/20 rounded-xl p-4">
            <div className="flex items-start gap-3">
              <ShieldCheck className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" />
              <p className="text-slate-400 text-xs leading-relaxed">
                Your information is processed securely via the <span className="text-emerald-400 font-semibold">Xendit platform</span> and
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-md">
          <div className="mb-7">
            ...
            <p className="text-slate-400 text-sm">Submit your KYC application to request dashboard access.</p>
          </div>

          {error && (
            <div className="flex items-start gap-2.5 bg-red-500/10 border border-red-500/25 text-red-400 rounded-xl px-4 py-3 mb-5 text-sm">
