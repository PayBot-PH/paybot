    ...
    return (
      <Card className="bg-card border-border">
        <CardContent className="flex flex-col items-center justify-center py-14 text-center">
          ...
          <p className="text-muted-foreground text-xs mt-1">PHP wallets are created when admins are registered or verified.</p>
        </CardContent>
      </Card>
    );
  }
      ...
      {wallets.map(w => (
        <Card key={w.wallet_id} className="bg-card border-border">
          <CardContent className="p-4 space-y-3">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <div className="h-9 w-9 rounded-xl bg-blue-500/15 border border-blue-500/25 flex items-center justify-center shrink-0">
              ...
              <div className="text-right shrink-0">
                <p className="text-blue-400 font-bold text-lg">₱{w.balance.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-muted/60 border border-border/60 text-foreground placeholder:text-muted-foreground rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 transition-colors"
                />
                <input
                  type="text"
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={adjusting === w.user_id}
                  className="flex-1 bg-red-600 hover:bg-red-700 text-white text-xs px-3"
                >
