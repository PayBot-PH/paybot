...
export default function Features() {
  ...
  const adminFeatures = [
    ...
    { icon: <ShieldCheck className="h-4 w-4 text-violet-400" />, title: 'Admin Management', description: 'Role-based access control. Super admin can add admins and assign granular permissions.', color: 'bg-violet-500/10' },
