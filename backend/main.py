...
async def lifespan(app: FastAPI):
    ...
    production_required: dict[str, str] = {
        # NOTE: settings.jwt_secret_key auto-generates an ephemeral value when not
        # set, so it is never empty.  Check the raw env var instead to detect whether
        # the operator actually configured a persistent secret.
